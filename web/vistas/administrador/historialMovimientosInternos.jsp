                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 style="color:#a20303">Historial Movimientos Internos</h6>
                            </div>
                    ...
                    <table class="table table-hover"data-draggable="target">
                        <thead class="thead-dark">
                            <tr data-draggable="item">
                                ...
                                <th scope="col">Usuario involucrado</th>
                        ...
                        <tbody>
                            ...
                            <s:iterator value="listaHistorial" status="stat" var="lista">


                                <tr data-draggable="item">
                                    <td><s:property value="#stat.count"/></td>
                                    <td><s:property value="fechaMovimiento"/></td>
                                    <td><s:property value="user.nombreUsuario"/></td>
                                    <td><s:property value="movimiento"/></td>
