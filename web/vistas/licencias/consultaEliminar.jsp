<%-- 
    Document   : consultaEliminar
    Created on : 12/07/2019, 07:42:00 PM
    Author     : BELTRAN PC
--%>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 style="color:#a20303">Licencias de Funcionamiento</h6>
                            </div>
                            <div class="card-body">
                                <div class="col-md-12" class="col-md-6" class="col-md-3">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <form action="eliminarLicencia" method="POST">
                                                <div class="form-row">
                                                    <div class="form-group col-md-6">
                                                        <label for="folio">Número de Licencia:</label>
                                                        <input type="text" class="form-control" id="inputEmail4" value="<s:property value="beanLicencia.no_Licencia"/>" placeholder="folio" disabled="">
                                                    </div>
                                                    <div class="form-group col-md-3">
                                                        <label for="inputPassword4">Giro:</label>
                                                        <select id="inputState" class="form-control" disabled="">
                                                            <option selected ><s:property value="beanLicencia.giro"/></option>
                                                        </select>
                                                    </div>
                                                    <div class="form-group col-md-3">
                                                        <label> Folio </label>
                                                        <input type="text" class="form-control" value="<s:property value="beanLicencia.folio"/>" name="" disabled="">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-row">
                                                    <div class="form-group col-md-12">
                                                        ...
                                                        <input type="text" class="form-control" id="inputAddress" value="<s:property value="beanLicencia.nombre_establecimiento"/>" placeholder="Nombre" disabled>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" value="<s:property value="beanLicencia.propietario"/>" id="inputAddress2" placeholder="Propietario" disabled>
                                                </div>
                                                <div class="form-row">
                                                    <div class="form-group col-md-6">
                                                        <label for="inputState">Representante Legal:</label>
                                                        <input type="text" class="form-control" id="inputAddress" value="<s:property value="beanLicencia.representante_legal"/>" placeholder="Representante Legal" disabled>
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                        <label for="inputState">Estado:</label>
                                                        <select id="inputState" class="form-control" disabled="">
                                                            <option selected ><s:property value="beanLicencia.fkestado.estado"/></option>
                                                        </select>
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                        <label for="inputState">Actividad Comercial:</label>
                                                        <select id="inputState" class="form-control" disabled="">
                                                            <option selected ><s:property value="beanLicencia.actividad_comercial"/></option>
                                                        </select>
                                                    </div>

                                                    <div class="form-group col-md-6">
                                                        <label for="inputState">RFC:</label>
                                                        <input type="text" class="form-control" value="<s:property value="beanLicencia.fkotrosdatos.rfc"/>" id="inputAddress" placeholder="RFC" disabled>
                                                    </div>

                                                    <div class="form-group col-md-12">
                                                        <label for="exampleFormControlTextarea1">Anotaciones: </label>
                                                        <textarea class="form-control" id="exampleFormControlTextarea1" rows="5" disabled=""><s:property value="beanLicencia.anotaciones"/></textarea>
                                                    </div>

                                                    <div class="form-group col-md-6">
                                                        <label for="inputState">Dirección:</label>
                                                        <input type="text" class="form-control" value="<s:property value="beanLicencia.direccion"/>" id="inputAddress" placeholder="Dirección" disabled>
                                                    </div>

                                                    <div class="form-group col-md-6">
                                                        <label for="inputState">Colonia:</label>
                                                        <select id="inputState" class="form-control" disabled="">
                                                            <option selected ><s:property value="beanLicencia.colonia"/></option>
                                                        </select>
                                                    </div>

                                                    <div class="form-group col-md-6">
                                                        <label for="inputState">Código postal:</label>
                                                        <input type="text" class="form-control" value="<s:property value="beanLicencia.codigo_postal"/>" id="inputAddress" placeholder="Código postal" disabled>
                                                    </div>

                                                    <div class="form-group col-md-6">
                                                        <label for="inputState">Télefono:</label>
                                                        <input type="text" class="form-control" value="<s:property value="beanLicencia.telefono"/>" id="inputAddress" placeholder="Télefono" disabled>
                                                    </div>


                                                    <div class="form-group col-md-6">
                                                        <label for="inputState">Hora de apertura (formato 24 hrs):</label>
                                                        <input type="time" class="form-control" id="inputAddress" value="<s:property value="beanLicencia.horario_apertura"/>" placeholder="Hora de apertura" disabled="">
                                                    </div>

                                                    <div class="form-group col-md-6">
                                                        <label for="inputState">Hora de cierre (formato 24 hrs):</label>
                                                        <input type="time" class="form-control" value="<s:property value="beanLicencia.horario_cierre"/>" id="inputAddress" placeholder="Hora de cierre" disabled="" >
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
                                            ...
                                            <form>
                                                <div class="form-row">
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input type="text" class="form-control" value="<s:property value="beanLicencia.fkcontribuyente.direccionCont"/>" id="inputAddress" placeholder="Dirección" disabled="">
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                        <label for="folio">Colonia de notificación:</label>
                                                        <input type="text" class="form-control" value="<s:property value="beanLicencia.fkcontribuyente.coloniaCont"/>" id="inputAddress" placeholder="Colonia" disabled="">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-row">
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <select id="inputState" class="form-control" disabled="">
                                                            <option selected ><s:property value="beanLicencia.fkcontribuyente.asociacion"/></option>
                                                        </select>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <form>
                                                <div class="form-row">
                                                    <div class="form-group col-md-6">
                                                        <label for="folio">Fecha Alta al Padrón:</label>
                                                        <input type="date" class="form-control" value="<s:property value="beanLicencia.fkotrosdatos.fecha_alta_padron"/>" id="inputAddress" placeholder="Alta Padrón" disabled="">
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                        <label for="folio">Fecha inscripción SHCP:</label>
                                                        <input type="date" class="form-control" value="<s:property value="beanLicencia.fkotrosdatos.fecha_alta_shcp"/>" id="inputAddress" placeholder="SHCP" disabled="">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-row">
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input type="text" class="form-control" value="<s:property value="beanLicencia.fkotrosdatos.curp"/>" id="inputAddress" placeholder="CURP" disabled="">
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                ...
                                                <div class="form-row">
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input type="text" class="form-control" value="<s:property value="beanLicencia.fkotrosdatos.no_empleados"/>" id="inputAddress" placeholder="Empleados" disabled="">
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                        <label for="folio">Superficie (m2):</label>
                                                        <input type="text" class="form-control" value="<s:property value="beanLicencia.fkotrosdatos.superficie"/>" id="inputAddress" placeholder="Superficie" disabled="">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-row">
                                                    <div class="form-group col-md-12">
                                                        ...
                                                        <textarea class="form-control" id="exampleFormControlTextarea1" rows="6" disabled=""><s:property value="beanLicencia.fkotrosdatos.observaciones"/></textarea>
                                                    </div>
                                                </div>
                                            </form>
                                            <form action="eliminarLicencia" method="POST">
                                                <input type="hidden" name="beanLicencia.no_Licencia" value="<s:property value="no_Licencia"/>" />
                                                <button type="submit" class="btn btn-danger">Suspender Licencia</button>
                                            </form>
                                        </div>
                                    </div>
                                    <br>
