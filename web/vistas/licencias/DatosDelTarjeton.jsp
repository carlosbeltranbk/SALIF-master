<%-- 
    Document   : DatosDelTarjeton
    Created on : 12/07/2019, 07:42:38 PM
    Author     : BELTRAN PC
--%>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 style="color:#a20303"> Datos del tarjetón </h6>
                            </div>
                            <div class="card-body">
                                            ...
                                            <form>
                                                <div class="form-row">
                                                    <div class="form-group col-md-4">
                                                        ...
                                                        <input type="text" class="form-control" id="inputEmail4" value="<s:property value="beanTarjeton.idTarjeton"/>" placeholder="folio" disabled="">
                                                    </div>
                                                    <div class="form-group col-md-4">
                                                        <label for="folio">Fecha:</label>
                                                        <input type="date" class="form-control" id="inputEmail4" value="<s:property value="beanTarjeton.fecha"/>" placeholder="folio" disabled="">
                                                    </div>
                                                    <div class="form-group col-md-4">
                                                        <label for="inputPassword4">Licencia:</label>
                                                        <input type="text" class="form-control" id="inputPassword4" value="<s:property value="beanTarjeton.no_Licencia"/>" placeholder="Licencia" disabled>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label for="inputAddress">Establecimiento:</label>
                                                    <input type="text" class="form-control" id="inputAddress" value="<s:property value="beanTarjeton.nombre_establecimiento"/>" placeholder="Establecimiento" disabled>
                                                </div>
                                                <div class="form-group">
                                                    <label for="inputAddress2">Propietario:</label>
                                                    <input type="text" class="form-control" id="inputAddress2" value="<s:property value="beanTarjeton.propietario"/>" placeholder="Propietario" disabled>
                                                </div>
                                                <div class="form-group">
                                                    <label for="inputAddress2">Periodo:</label>
                                                    <input type="text" class="form-control" id="inputAddress2" value="<s:property value="beanTarjeton.periodo"/>" placeholder="Periodo" disabled>
                                                </div>
                                                <div class="form-group">
                                                    <label for="inputAddress2">Domicilio:</label>
                                                    <input type="text" class="form-control" id="inputAddress2" value="<s:property value="beanTarjeton.domicilio"/>" placeholder="Domicilio" disabled>
                                                </div>
                                                <div class="form-row">
                                                    <div class="form-group col-md-6">
                                                        <label for="folio">Colonia:</label>
                                                        <input type="text" class="form-control" id="inputEmail4" value="<s:property value="beanTarjeton.colonia"/>" placeholder="Colonia" disabled="">
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                        <label for="folio">Código Postal:</label>
                                                        <input type="number" class="form-control" id="inputEmail4" value="<s:property value="beanTarjeton.codigo_postal"/>" placeholder="Código Postal" disabled="">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label for="inputAddress2">RFC:</label>
                                                    <input type="text" class="form-control" id="inputAddress2" value="<s:property value="beanTarjeton.rfc"/>" placeholder="RFC" disabled>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <form>
                                                <div class="form-row">
                                                    <div class="form-group col-md-4">
                                                        <label for="folio">Giro:</label>
                                                        <input type="text" class="form-control" id="inputEmail4" value="<s:property value="beanTarjeton.giro"/>" placeholder="Giro" disabled="">
                                                    </div>
                                                    <div class="form-group col-md-4">
                                                        <label for="folio">Horario de Apertura (formato 24 hrs.):</label>
                                                        <input type="time" class="form-control" id="inputEmail4" placeholder="" value="<s:property value="beanTarjeton.horario_apertura"/>" disabled="">
                                                    </div>
                                                    <div class="form-group col-md-4">
                                                        <label for="inputPassword4">Horario de Cierre (formato de 24 hrs.):</label>
                                                        <input type="time" class="form-control" id="inputPassword4" placeholder="" value="<s:property value="beanTarjeton.horario_cierre"/>" disabled>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label for="inputAddress">Actividad:</label>
                                                    <input type="text" class="form-control" id="inputAddress" placeholder="actividad" value="<s:property value="beanTarjeton.actividad_comercial"/>" disabled="">
                                                </div>
                                                <div class="form-row">
                                                    <div class="form-group col-md-6">
                                                        <label for="inputState">Fecha de Recibo:</label>
                                                        <input type="date" class="form-control" id="inputAddress" placeholder="" value="<s:property value="beanTarjeton.fecha_recibo"/>" disabled="">
                                                    </div>
                                                </div>
