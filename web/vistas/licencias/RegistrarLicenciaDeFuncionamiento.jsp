                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input type="text" class="form-control" name="beanLicencia.direccion" id="inputAddress" placeholder="Dirección" >
                                                    </div>
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input type="text" class="form-control" name="beanLicencia.codigo_postal" id="inputAddress" placeholder="Código postal" >
                                                    </div>
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input type="text" class="form-control" name="beanLicencia.telefono" id="inputAddress" placeholder="Télefono" >
                                                    </div>
                                            ...
                                            <div class="card-body">
                                                <div class="form-row">
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input type="text" class="form-control" name="beanLicencia.fkcontribuyente.direccionCont" id="inputAddress" placeholder="Dirección" >
                                                    </div>
                                                    <div class="form-group col-md-6">
