            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <table class="table table-hover"data-draggable="target">
                        ...
                        <tbody >
                            <s:iterator value="listaCuentasContables" status="stat" var="lista">
                                ...
                                <tr data-draggable="item">
                                    ...
                                    <td><input class="btn btn-outline-success btn-sm" type="submit" onclick="agregarConcepto(<s:property value="idCuenta"/>)" value="Agregar Concepto"></td>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="" class="form-control mx-sm-3" placeholder="$0.00" disabled="">
                    </div>
                    <div class="container" style="margin-top:50px">         
                        <div class="row">
                            <div class="col-md-2"></div>
                            <div class="col-md-8">
                                <input class="btn btn-outline-success btn-block" onclick="mostrarIds()" type="submit" value="Generar Orden"/>
                                <form action="<%=context%>/previewConceptos" method="POST">
                                    <input type="text" name="idsCuentasContables" id="idsCuentasContables"/>
                                    
                                    <input class="btn btn-outline-success btn-block" onclick="cargarIds()" type="submit" value="Generar Orden">
                    ...
                    <div class="container" style="margin-top:50px">         
                        <div class="row">
                            <div class="col-md-2"></div>
                            <div class="col-md-8">
                                <form action="<%=context%>/eliminarOrdenDePago" method="POST">
                                   
                                    <input class="btn btn-outline-danger btn-block"  type="submit" value="Cancelar">
                                </form>
                            </div>
                            <div class="col-md-2"></div>
                        </div>
...
<script src="<%=context%>/js/OrdenDePago.js"></script>    
