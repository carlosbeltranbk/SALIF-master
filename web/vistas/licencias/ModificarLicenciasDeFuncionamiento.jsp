<%-- 
    Document   : ModificarLicenciasDeFuncionamiento
    Created on : 12/07/2019, 07:43:28 PM
    Author     : BELTRAN PC
--%>
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item" href="<%=context%>/generarPadron">Generación de padrones</a>
                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                <div class="col-md-12" class="col-md-6" class="col-md-3">
                                    ...
                                    <!-- DATOS GENERALES  --- --- --- --- --- --->
                                    <br>
                                    <form action="modificarLicencia" method="POST">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <div class="form-row">
                                                    <div class="form-group col-md-6">
                                                        <label for="folio">Número de Licencia:</label>
                                                        <input type="text" class="form-control" name="beanLicencia.no_Licencia" value="<s:property value="beanLicencia.no_Licencia"/>" hidden="" id="inputEmail4" placeholder="folio" >
                                                        <input type="text" class="form-control" name="beanLicencia.no_Licencia" value="<s:property value="beanLicencia.no_Licencia"/>" disabled="" id="inputEmail4" placeholder="folio" >
                                                    </div>
                                                    <div class="form-group col-md-3">
                                                        <label for="inputPassword4">Giro:</label>
                                                        <input type="text" name="beanLicencia.giro" value="<s:property value="beanLicencia.giro"/>" class="form-control" id="inputAddress" hidden="">
                                                        <input type="text" name="beanLicencia.giro" value="<s:property value="beanLicencia.giro"/>" class="form-control" id="inputAddress" disabled="">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-row">
                                                    <div class="form-group col-md-12">
                                                        ...
                                                        <input type="text" name="beanLicencia.nombre_establecimiento" value="<s:property value="beanLicencia.nombre_establecimiento"/>" class="form-control" id="inputAddress" placeholder="Nombre del establecimiento" >
                                                    </div>
                                                </div>

                                                <div class="form-group">
                                                    <label for="inputAddress2">Propietario:</label>
                                                    <input type="text" name="beanLicencia.propietario" value="<s:property value="beanLicencia.propietario"/>" class="form-control" id="inputAddress2" placeholder="Propietario" >
                                                </div>

                                                <div class="form-row">
                                                    <div class="form-group col-md-6">
                                                        <label for="inputState">Representante Legal:</label>
                                                        <input type="text" name="beanLicencia.representante_legal" value="<s:property value="beanLicencia.representante_legal"/>" class="form-control" id="inputAddress" placeholder="Representante Legal" >
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input type="text" name="beanLicencia.actividad_comercial" value="<s:property value="beanLicencia.actividad_comercial"/>" class="form-control" id="inputAddress" placeholder="Actividad Comercial" hidden="">
                                                        <input type="text" name="beanLicencia.actividad_comercial" value="<s:property value="beanLicencia.actividad_comercial"/>" class="form-control" id="inputAddress" placeholder="Actividad Comercial" disabled="">
                                                    </div>

                                                    <div class="form-group col-md-12">
                                                        <label for="exampleFormControlTextarea1">Anotaciones: </label>
                                                        <textarea class="form-control" name="beanLicencia.anotaciones"id="exampleFormControlTextarea1" rows="5" ><s:property value="beanLicencia.anotaciones"/></textarea>
                                                    </div>

                                                    <div class="form-group col-md-6">
                                                        <label for="inputState">Dirección:</label>
                                                        <input type="text" class="form-control" name="beanLicencia.direccion" value="<s:property value="beanLicencia.direccion"/>" id="inputAddress" placeholder="Dirección" >
                                                    </div>

                                                    <div class="form-group col-md-6">
                                                        <label for="inputState">Colonia:</label>
                                                        <input type="text" class="form-control" name="beanLicencia.colonia" value="<s:property value="beanLicencia.colonia"/>" id="inputAddress" placeholder="colonia" >
                                                    </div>

                                                    <div class="form-group col-md-6">
                                                        <label for="inputState">Código postal:</label>
                                                        <input type="text" class="form-control" name="beanLicencia.codigo_postal" value="<s:property value="beanLicencia.codigo_postal"/>" id="inputAddress" placeholder="Código postal" >
                                                    </div>

                                                    <div class="form-group col-md-6">
                                                        <label for="inputState">Correo:</label>
                                                        <input type="email" class="form-control" name="beanLicencia.correo" value="<s:property value="beanLicencia.correo"/>" id="inputAddress" placeholder="Correo Electronico" >
                                                    </div>

                                                    <div class="form-group col-md-6">
                                                        <label for="inputState">Télefono:</label>
                                                        <input type="text" class="form-control" name="beanLicencia.telefono" value="<s:property value="beanLicencia.telefono"/>" id="inputAddress" placeholder="Télefono" >
                                                    </div>


                                                    <div class="form-group col-md-6">
                                                        <label for="inputState">Hora de apertura:</label>
                                                        <input type="time" class="form-control" name="beanLicencia.horario_apertura" value="<s:property value="beanLicencia.horario_apertura"/>" id="inputAddress" placeholder="Hora de apertura" >
                                                    </div>

                                                    <div class="form-group col-md-6">
                                                        <label for="inputState">Hora de cierre:</label>
                                                        <input type="time" class="form-control" id="inputAddress" name="beanLicencia.horario_cierre" value="<s:property value="beanLicencia.horario_cierre"/>" placeholder="Hora de cierre" >
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <div class="form-row">
                                                    <div class="form-group col-md-6">
                                                        <label for="folio">Dirección de notificación:</label>
                                                        <input type="text" class="form-control" name="beanLicencia.fkcontribuyente.direccionCont" value="<s:property value="beanLicencia.fkcontribuyente.direccionCont"/>" id="inputAddress" placeholder="Dirección" >
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                        <label for="folio">Colonia de notificación:</label>
                                                        <input type="text" class="form-control" name="beanLicencia.fkcontribuyente.coloniaCont" value="<s:property value="beanLicencia.fkcontribuyente.coloniaCont"/>" id="inputAddress" placeholder="Colonia" >
                                                    </div>
                                                </div>

                                                <div class="form-row">
                                                    <div class="form-group col-md-6">
                                                        <label for="inputState">Asociación:</label>
                                                        <input type="text" class="form-control" name="beanLicencia.fkcontribuyente.asociacion" value="<s:property value="beanLicencia.fkcontribuyente.asociacion"/>" id="inputAddress" placeholder="Asociacion" >
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <div class="form-row">
                                                    <div class="form-group col-md-6">
                                                        <label for="folio">Fecha inscripción SHCP:</label>
                                                        <input type="date" name="beanLicencia.fkotrosdatos.fecha_alta_shcp" value="<s:property value="beanLicencia.fkotrosdatos.fecha_alta_shcp"/>" class="form-control" id="inputAddress" placeholder="SHCP" >
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-row">
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input type="text" name="beanLicencia.fkotrosdatos.curp" value="<s:property value="beanLicencia.fkotrosdatos.curp"/>" class="form-control" id="inputAddress" placeholder="CURP" >
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                        <label for="folio">RFC:</label>
                                                        <input type="text"name="beanLicencia.fkotrosdatos.rfc" value="<s:property value="beanLicencia.fkotrosdatos.rfc"/>" class="form-control" id="inputAddress" placeholder="RFC" >
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-row">
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input type="number" name="beanLicencia.fkotrosdatos.no_empleados" value="<s:property value="beanLicencia.fkotrosdatos.no_empleados"/>" class="form-control" id="inputAddress" placeholder="Empleados" >
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                        <label for="folio">Superficie (m2):</label>
                                                        <input type="text" name="beanLicencia.fkotrosdatos.superficie" value="<s:property value="beanLicencia.fkotrosdatos.superficie"/>" class="form-control" id="inputAddress" placeholder="Superficie" >
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-row">
                                                    <div class="form-group col-md-12">
                                                        ...
                                                        <textarea class="form-control" name="beanLicencia.fkotrosdatos.observaciones" id="exampleFormControlTextarea1" rows="6" ><s:property value="beanLicencia.fkotrosdatos.observaciones"/></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
