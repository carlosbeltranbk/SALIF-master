                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 style="color:#a20303"> Generación de Padrones </h6>
                            </div>
                            <div class="card-body">
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-2">
                                                        <div class="form-check form-check-inline">
                                                            ...
                                                            <label class="form-check-label" for="inlineRadio1">Por Año de Apertura/Refrendo</label>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-3">
                                                        <label for="inputState">Del año:</label>
                                                        <input type="date" class="form-control" id="año" placeholder="Código postal" disabled="">
                                                    </div>

                                                    <div class="form-group col-md-3">
                                                        <label for="inputState">Al año:</label>
                                                        <input type="date" class="form-control" id="año" placeholder="Télefono" disabled="">
                                                    </div> 
                                                ...
                                                <div class="form-row">
                                                    <div class="form-group col-md-4">
                                                        <div class="form-check form-check-inline">
                                                            ...
                                                            <label class="form-check-label" for="inlineRadio1">Número de Licencia</label>
                                                        </div>
                                                    </div>
                                                    <div class="form-group col-md-4">
                                                        <div class="form-check form-check-inline">
