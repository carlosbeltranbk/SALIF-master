        ...
        <div id="wrapper">
            ...
            <ul class="navbar-nav bg-gradient-danger sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                    ...
                    <div class="sidebar-brand-text mx-3"><s:property value="#session['rol']"/> TMX</div>
                </a>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 style="color:#a20303"> Elaboración de Ordenes de Pago </h6>
                            </div>
                            <div class="card-body">
                                <div class="col-md-12" class="col-md-6" class="col-md-3">
                                    <form class="form-inline" action="consultarLicenciaOrdenPagoId" method="POST">
                                        <div class="form-group">
                                            <label for="num_Licencia">Número de licencia:</label>
                                            <input required="" type="text" name="BeanLicencia.no_Licencia" placeholder="123..." class="form-control mx-sm-3">
                                            ...
                                            <form>
                                                <div class="form-row">
                                                    <div class="form-group col-md-6">
                                                        <label for="folio">Folio de licencia:</label>
                                                        <input type="text" class="form-control" id="inputEmail4" placeholder="folio" disabled="" value="<s:property value="beanLicencia.folio"/>">
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                        <label for="no_Licencia">Licencia:</label>
                                                        <input type="text" class="form-control" id="inputPassword4" placeholder="Licencia" disabled="" value="<s:property value="beanLicencia.no_Licencia"/>">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label for="nombre_establecimiento">Nombre del establecimiento:</label>
                                                    <input type="text" class="form-control" id="inputAddress" placeholder="Nombre" disabled value="<s:property value="beanLicencia.nombre_establecimiento"/>">
                                                </div>
                                                <div class="form-group">
                                                    <label for="propietario">Propietario:</label>
                                                    <input type="text" class="form-control" id="inputAddress2" placeholder="Propietario" disabled value="<s:property value="beanLicencia.propietario"/>">
                                                </div>
                                                <div class="form-row">
                                                    <div class="form-group col-md-6">
                                    ...
                                    <br>
                                    <form class="form-inline" action="crearOrdenDePagoId" method="POST">
                                        <div class="form-group">
