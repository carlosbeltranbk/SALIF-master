                    ...
                    <div class="signin-form">
                        ...
                        <s:form action="iniciarSesion" theme="simple">                    
                            <div class="form-group">
                                ...
                                <input required type="text" name="user" id="your_name" placeholder="usuario"/>
                            </div>
                            <div class="form-group">
                                <label for="your_pass"><i class="zmdi zmdi-lock"></i></label>
                                <input required type="password" name="contrasena" id="your_pass" placeholder="contraseña"/>
                            </div>
                            <h6 class="d-flex justify-content-center links"><s:property value="respuesta"/></h6>
